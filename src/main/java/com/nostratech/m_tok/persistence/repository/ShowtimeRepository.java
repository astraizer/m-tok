...
public interface ShowtimeRepository extends JpaRepository<Showtime, Long> {
    @Query(value = """
            ...
            """)
    List<Showtime> findByCinemaIdAndStudioType(Long cinemaId,Integer studioType);
    ...
    @Query(value = """
            ...
            group by m.id,m.name,m.image,s.price 
    """,nativeQuery = true)
    List<Object []> findMovieByCinemaIdAndStudioType(Long cinemaId,Integer studioType);
}
